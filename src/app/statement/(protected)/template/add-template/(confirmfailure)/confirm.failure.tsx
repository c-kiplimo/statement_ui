...
const ConfirmTemplateFail = ({title, description, onClick, onCancel}: CreationSuccessProps) => {
  return (
    <div className={styles.container}>
        <Image src={'/errorIcon.svg'} width={56} height={56} alt='errorIcon'/>

      <div className={`${styles.content}`}>
        <div className={`${styles.body} sm:w-[341px]`}>
...
export default ConfirmTemplateFail
