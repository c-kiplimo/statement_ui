...
RecentTransactionsCard.Title = (props: titleProps) => (
    <VerticalInfoDescription title={props.title} titleStyle={{ fontSize: '20px', fontWeight: '700', lineHeight: '32px' }} />
);
...
RecentTransactionsCard.Dropdown = (props: dropdownProps) => (
    <SelectedInput options={props.option} selectionStyles={{ width: '115px', height: '32px', outline: 'none', border: '1px solid grey', borderRadius: '4px', color: '#6F7269' }} />
);
